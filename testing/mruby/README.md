...
| Ported module: graphics (real shader-based batched renderer, OpenGL backend; clear/color/rectangle/present + transform stack (origin/push/pop/translate/rotate/scale/shear/apply_transform/transform_point) + render state (blend/scissor/color_mask/line/point/wireframe) + new_image/new_quad/draw + new_font/print/printf; Texture, Quad & Font object types) | `src/modules/graphics/wrap_Graphics_mrb.cpp` |

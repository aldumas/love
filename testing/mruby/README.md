...
2. DONE: the Lua boot scripts (`boot.lua`, `callbacks.lua`, `arg.lua`) are
   ...
   object type (`new_sprite_batch` + add/set/clear/color/draw-range),
   plus
   ...
   (Mesh, ParticleSystem, TextBatch, Video).
